LOFT-HF Data Dictionary
======================

[![Build Status](https://app.travis-ci.com/nsrr/lofthf-data-dictionary.svg?branch=master)](https://app.travis-ci.com/nsrr/lofthf-data-dictionary)

### Exports

The LOFT-HF data dictionary can be exported to CSV by typing:
...
The LOFT-HF data dictionary is tested using the
...
[CHANGELOG](https://github.com/nsrr/lofthf-data-dictionary/blob/master/CHANGELOG.md).
